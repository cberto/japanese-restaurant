...
window.onscroll = function() {
    ...
    if (window.pageYOffset > headerSection.offsetHeight - 75) {
        ...
        logoImage.src = "https://res.cloudinary.com/dvdq3xuzq/image/upload/bo_0px_solid_rgb:000,c_scale,w_80/v1664031533/Parcial/japanese-bar-logo-concept-with-torii-gate-and-sushi-roll-vector-removebg-preview_guaxkv.png";
    } else {
    ...
    if (pageTitle.text === "SushiTori- Restaurant") {
...
if (pageTitle.text === "sushiTori- Restaurant") {
    ...
    darkToggle.addEventListener('change', ()=> {
      ...
      Array.from(document.getElementsByTagName('p')).forEach((el)=>el.classList.toggle('white') )
